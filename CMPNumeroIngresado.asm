...
var DW 11	;	define la variable var con numero 10, a comparar, de tipp	Word
.code
main proc
etiqueta1: 
...
CMP var,ax	;se compara var con ax
JLE etiqueta1	;si ax es menor que var, el programa regresa a etiqueta 1, si no avanza
